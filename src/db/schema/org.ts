...
// Auto-generated: 2025-12-23T07:04:05.105347
...
export const orgdivision = pgTable('org_division', {
  ...
  tipo: text('tipo').notNull(),
  division_padre_id: uuid('division_padre_id'),
  jefe_id: uuid('jefe_id').notNull(),
  nivel_jerarquico: integer('nivel_jerarquico').notNull(),
