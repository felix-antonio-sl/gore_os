...
> **Nota sobre Cumplimiento:** GORE_OS distingue tres dimensiones de cumplimiento:
...
```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│                    D-TDE: GOBERNANZA DIGITAL REGIONAL                               │
├─────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                      │
│  ╔═══════════════════════════════════════════════════════════════════════════════╗  │
...
*Versión: 3.1 | Fecha: Diciembre 2024*
*Última revisión: 15-12-2024 | Cambios: Coherencia semántica refinada - "modelo integrado de funciones" (no "4 núcleos"); D-TDE como "Gobernanza Digital" consistente; clarificación 3 tipos de cumplimiento (D-NORM general, D-TDE Ley TDE, Embebido transversal)*
