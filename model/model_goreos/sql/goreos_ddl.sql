...
\restrict NMFrJ9BglWRqTau7JbNVMoC3ERTL3jeDVK3aABUMrkWVo8mCRThP5mu5tR4Cbzj
...
--
-- Name: fn_ipr_phase_entered(); Type: FUNCTION; Schema: public; Owner: goreos
--
...
ALTER FUNCTION public.fn_ipr_phase_entered() OWNER TO goreos;
...
--
-- Name: COLUMN financing_track.role_permissions; Type: COMMENT; Schema: core; Owner: goreos
--

COMMENT ON COLUMN core.financing_track.role_permissions IS 'Track-specific role overrides per boundary key. Keys: boundary names (e.g. register_eval_result). Values: role code arrays. Empty {} means use universal defaults.';
...
--
-- Name: ipr_closure; Type: TABLE; Schema: core; Owner: goreos
--
...
ALTER TABLE core.ipr_closure OWNER TO goreos;

--
-- Name: ipr_expost_evaluation; Type: TABLE; Schema: core; Owner: goreos
--
...
ALTER TABLE core.ipr_expost_evaluation OWNER TO goreos;
...
--
-- Name: ipr_modification; Type: TABLE; Schema: core; Owner: goreos
--
...
ALTER TABLE core.ipr_modification OWNER TO goreos;
...
--
-- Name: notification; Type: TABLE; Schema: core; Owner: goreos
--
...
ALTER TABLE core.notification OWNER TO goreos;
...
--
-- Name: ipr_closure ipr_closure_ipr_id_key; Type: CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_closure ipr_closure_pkey; Type: CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_expost_evaluation ipr_expost_evaluation_pkey; Type: CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_pkey; Type: CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: notification notification_pkey; Type: CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: idx_budget_program_division; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_budget_program_division ON core.budget_program USING btree (owner_division_id) WHERE (owner_division_id IS NOT NULL);


--
-- Name: idx_budget_program_fiscal_year; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_budget_program_fiscal_year ON core.budget_program USING btree (fiscal_year, owner_division_id);
...
--
-- Name: idx_document_agreement_id; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_document_agreement_id ON core.document USING btree (agreement_id) WHERE (agreement_id IS NOT NULL);
...
--
-- Name: idx_document_ipr_id; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_document_ipr_id ON core.document USING btree (ipr_id) WHERE (ipr_id IS NOT NULL);


--
-- Name: idx_document_type_id; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_document_type_id ON core.document USING btree (document_type_id);
...
--
-- Name: idx_expost_eval_ipr; Type: INDEX; Schema: core; Owner: goreos
--
...
--
-- Name: idx_ipr_modification_ipr; Type: INDEX; Schema: core; Owner: goreos
--
...
--
-- Name: idx_ipr_modification_status; Type: INDEX; Schema: core; Owner: goreos
--
...
--
-- Name: idx_notification_user; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_notification_user ON core.notification USING btree (user_id, read_at, created_at DESC) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_rendition_state; Type: INDEX; Schema: core; Owner: goreos
--

CREATE INDEX idx_rendition_state ON core.rendition USING btree (state_id) WHERE (deleted_at IS NULL);
...
--
-- Name: ipr trg_ipr_phase_entered; Type: TRIGGER; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification trg_modification_state_transition; Type: TRIGGER; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_closure ipr_closure_closure_act_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_closure ipr_closure_created_by_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_closure ipr_closure_ipr_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_closure ipr_closure_signed_by_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_expost_evaluation ipr_expost_evaluation_evaluation_type_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_expost_evaluation ipr_expost_evaluation_evaluator_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_expost_evaluation ipr_expost_evaluation_ipr_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_expost_evaluation ipr_expost_evaluation_overall_rating_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_approved_by_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_ipr_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_modification_type_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_requested_by_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: ipr_modification ipr_modification_status_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--
...
--
-- Name: notification notification_user_id_fkey; Type: FK CONSTRAINT; Schema: core; Owner: goreos
--

ALTER TABLE ONLY core.notification
    ADD CONSTRAINT notification_user_id_fkey FOREIGN KEY (user_id) REFERENCES core."user"(id);
