...
--   - Todos los registros demo tienen códigos con prefijo DEMO-
--   - Los schemes estructurales (budget_item, etc.) son PERMANENTES — no son demo
--   - Para limpiar SOLO datos demo: ejecutar goreos_unseed_demo_ciclo2.sql
-- =============================================================================

BEGIN;

-- =============================================================================
-- PARTE 1: SCHEMES ESTRUCTURALES (permanentes, no demo)
-- Estos esquemas son necesarios para el funcionamiento del módulo de presupuesto
-- =============================================================================
...
-- ASIGNACIONES PRESUPUESTARIAS (representativas, no exhaustivas)
INSERT INTO ref.category (scheme, code, label, description, sort_order) VALUES
...
-- =============================================================================
-- PARTE 2: DATOS DEMO (removibles con goreos_unseed_demo_ciclo2.sql)
