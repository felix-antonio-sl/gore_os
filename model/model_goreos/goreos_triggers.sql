...
BEGIN
    ...
    -- Determinar el actor (del contexto de sesión si existe)
...
BEGIN
    ...
    -- Obtener siguiente secuencia (simplificado)
    EXECUTE format('
...
'Genera código secuencial: PREFIX-YYYY-NNNNN';
