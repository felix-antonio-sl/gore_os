...
async def _dashboard_jefe_division(user: dict, db: AsyncSession) -> DashboardResponse:
    ...
    kpis = [
        ...
        KPICard(label="Alertas div",         value=alert_kpi_row["alertas_div"]     or 0, sublabel="Sin resolver",             color="red"),
    ]
...
async def _dashboard_admin_regional(user: dict, db: AsyncSession) -> DashboardResponse:
    ...
    kpis = [
        ...
        KPICard(label="Problemas >7d",           value=prob7_row["problemas_7d"]           or 0, sublabel="Sin resolver >7 días",    color="orange"),
        KPICard(label="Alertas sin atender",     value=alertas_row["alertas_sin_atender"]  or 0, sublabel="Requieren atención",      color="amber"),
    ]
